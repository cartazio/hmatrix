...
foreign import ccall unsafe "bsd-aux.h sumF" c_sumF :: TFF
foreign import ccall unsafe "bsd-aux.h sumR" c_sumR :: TVV
foreign import ccall unsafe "bsd-aux.h sumQ" c_sumQ :: TQVQV
foreign import ccall unsafe "bsd-aux.h sumC" c_sumC :: TCVCV
...
foreign import ccall unsafe "bsd-aux.h prodF" c_prodF :: TFF
foreign import ccall unsafe "bsd-aux.h prodR" c_prodR :: TVV
foreign import ccall unsafe "bsd-aux.h prodQ" c_prodQ :: TQVQV
foreign import ccall unsafe "bsd-aux.h prodC" c_prodC :: TCVCV
...
foreign import ccall unsafe "bsd-aux.h dotF" c_dotF :: TFFF
foreign import ccall unsafe "bsd-aux.h dotR" c_dotR :: TVVV
foreign import ccall unsafe "bsd-aux.h dotQ" c_dotQ :: TQVQVQV
foreign import ccall unsafe "bsd-aux.h dotC" c_dotC :: TCVCVCV
...
foreign import ccall unsafe "bsd-aux.h toScalarR" c_toScalarR :: CInt -> TVV

-- | obtains different functions of a vector: norm1, norm2, max, min, posmax, posmin, etc.
toScalarF :: FunCodeS -> Vector Float -> Float
toScalarF oper =  toScalarAux c_toScalarF (fromei oper)

foreign import ccall unsafe "bsd-aux.h toScalarF" c_toScalarF :: CInt -> TFF
...
foreign import ccall unsafe "bsd-aux.h toScalarC" c_toScalarC :: CInt -> TCVV

-- | obtains different functions of a vector: only norm1, norm2
toScalarQ :: FunCodeS -> Vector (Complex Float) -> Float
toScalarQ oper =  toScalarAux c_toScalarQ (fromei oper)

foreign import ccall unsafe "bsd-aux.h toScalarQ" c_toScalarQ :: CInt -> TQVF
...
foreign import ccall unsafe "bsd-aux.h mapR" c_vectorMapR :: CInt -> TVV
...
foreign import ccall unsafe "bsd-aux.h mapC" c_vectorMapC :: CInt -> TCVCV

-- | map of real vectors with given function
vectorMapF :: FunCodeV -> Vector Float -> Vector Float
vectorMapF = vectorMapAux c_vectorMapF

foreign import ccall unsafe "bsd-aux.h mapF" c_vectorMapF :: CInt -> TFF

-- | map of real vectors with given function
vectorMapQ :: FunCodeV -> Vector (Complex Float) -> Vector (Complex Float)
vectorMapQ = vectorMapAux c_vectorMapQ

foreign import ccall unsafe "bsd-aux.h mapQ" c_vectorMapQ :: CInt -> TQVQV
...
foreign import ccall unsafe "bsd-aux.h mapValR" c_vectorMapValR :: CInt -> Ptr Double -> TVV
...
foreign import ccall unsafe "bsd-aux.h mapValC" c_vectorMapValC :: CInt -> Ptr (Complex Double) -> TCVCV

-- | map of real vectors with given function
vectorMapValF :: FunCodeSV -> Float -> Vector Float -> Vector Float
vectorMapValF oper = vectorMapValAux c_vectorMapValF (fromei oper)

foreign import ccall unsafe "bsd-aux.h mapValF" c_vectorMapValF :: CInt -> Ptr Float -> TFF
...
foreign import ccall unsafe "bsd-aux.h mapValQ" c_vectorMapValQ :: CInt -> Ptr (Complex Float) -> TQVQV
...
foreign import ccall unsafe "bsd-aux.h zipR" c_vectorZipR :: CInt -> TVVV
